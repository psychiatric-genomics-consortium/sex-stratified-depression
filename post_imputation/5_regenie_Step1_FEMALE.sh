## Script to run step 1 of regenie using imputed data for females in bfile format
...
echo "FID IID pheno" > $1_qc1_female.pheno
awk '{ print $1, $2, $6 }' $1_qc1_female.fam >> $1_qc1_female.pheno
...
--bsize 100 \
--bt \
--out $1_qc1_regenie_step1_female
